    ...
    return (
      <div className="py-20 justify-center text-center animate-fade-in">
        ...
        <p className="text-slate-500 font-medium">
          Our servers are taking a short break. Please try again later.
        </p>
      </div>
    );
  }
  ...
  if (!products.length) {
    return (
      <div className="py-20 text-center animate-fade-in">
        <div className="inline-flex p-4 rounded-full bg-slate-50 text-slate-400 mb-6 font-black text-4xl">
          ?
        </div>
